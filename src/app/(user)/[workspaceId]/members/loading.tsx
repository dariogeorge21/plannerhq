    ...
    <div className="max-w-7xl mx-auto p-6 lg:p-10 space-y-8 animate-pulse">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6">
        <div className="space-y-3">
          ...
          <div className="h-4 w-96 bg-muted/50 rounded-lg"></div>
        </div>
        <div className="h-11 w-40 bg-muted rounded-xl"></div>
      </div>
        ...
        {[...Array(4)].map((_, i) => (
          <div key={i} className="bg-card border border-border rounded-2xl p-5 shadow-sm flex flex-col h-[130px]">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-xl bg-muted/50"></div>
              <div className="h-4 w-24 bg-muted/50 rounded"></div>
            </div>
            <div className="h-10 w-16 bg-muted rounded mt-auto"></div>
          </div>
        ))}
      </div>
